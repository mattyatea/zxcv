/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6c17cec408d7bca57d98fda16b07e1f6)
...
declare namespace Cloudflare {
	interface Env {
		...
		EMAIL_FROM: "noreply@zxcv.dev";
		FRONTEND_URL: "https://zxcv.dev";
		JWT_SECRET: string;
		R2: R2Bucket;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_ALGORITHM" | "JWT_EXPIRES_IN" | "RATE_LIMIT_ANONYMOUS" | "RATE_LIMIT_AUTHENTICATED" | "RATE_LIMIT_API_KEY" | "EMAIL_FROM" | "FRONTEND_URL" | "JWT_SECRET">> {}
}
