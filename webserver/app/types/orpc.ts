...
export type InviteMemberResponse =
	RouterOutputs["organizations"]["inviteMember"];
export type RemoveMemberResponse =
	RouterOutputs["organizations"]["removeMember"];
export type AcceptInvitationResponse =
	RouterOutputs["organizations"]["acceptInvitation"];
export type GetPublicOrganizationResponse =
	RouterOutputs["organizations"]["getPublicProfile"];
