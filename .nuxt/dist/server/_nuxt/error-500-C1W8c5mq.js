import { mergeProps, useSSRContext } from "/Users/sou_kohata/WebstormProjects/zxcv/node_modules/.pnpm/vue@3.5.17_typescript@5.8.3/node_modules/vue/index.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-c9956c69><div class="-bottom-1/2 fixed h-1/2 left-0 right-0 spotlight" data-v-c9956c69></div><div class="max-w-520px text-center" data-v-c9956c69><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-c9956c69>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-c9956c69>${ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.7_@biomejs+biome@2.1.2_@netlify+blobs@9.1.2_@parcel+watcher@2.5.1_@types+node_639a525bd398eaabb93b667a9f677058/node_modules/nuxt/dist/app/components/error-500.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c9956c69"]]);
export {
  error500 as default
};
//# sourceMappingURL=error-500-C1W8c5mq.js.map
