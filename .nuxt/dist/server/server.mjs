...
import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, ref, computed, defineAsyncComponent, unref, Suspense, nextTick, mergeProps, Fragment, readonly, watch, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "/Users/sou_kohata/WebstormProjects/zxcv/node_modules/.pnpm/vue@3.5.17_typescript@5.8.3/node_modules/vue/index.mjs";
...
import destr from "/Users/sou_kohata/WebstormProjects/zxcv/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs";
import { withBase, withQuery, hasProtocol, isScriptProtocol, joinURL } from "/Users/sou_kohata/WebstormProjects/zxcv/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/sou_kohata/WebstormProjects/zxcv/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/sou_kohata/WebstormProjects/zxcv/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeaders, getRequestURL } from "/Users/sou_kohata/WebstormProjects/zxcv/node_modules/.pnpm/h3@1.15.3/node_modules/h3/dist/index.mjs";
import { shouldHydrate, createPinia, setActivePinia, defineStore } from "pinia";
import { defu } from "/Users/sou_kohata/WebstormProjects/zxcv/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs";
...
import { toRouteMatcher, createRouter } from "/Users/sou_kohata/WebstormProjects/zxcv/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs";
...
const _ht = class _ht {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import("./_nuxt/multipart-parser-BPNWO1dG.js");
...
async function applyPlugins(nuxtApp, plugins2) {
  ...
  async function executePlugin(plugin2) {
    ...
    if (unresolvedPluginsForThisPlugin.length > 0) {
      ...
      if (plugin2.parallel) {
        parallels.push(promise.catch((e) => errors2.push(e)));
      } else {
        await promise;
      }
    }
...
const unhead__l5cQJCU8jr_3zb17LTUbdWrbaP2QA6QnEx_mf3JnCM = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BO1aIDl8.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/login-D6A0VBpp.js")
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/register-Bj4Wsid2.js")
  },
  {
    name: "testOrpc",
    path: "/testOrpc",
    component: () => import("./_nuxt/testOrpc-D1V5A7VZ.js")
  },
  {
    name: "rules-new",
    path: "/rules/new",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/new-BJ89lsD3.js")
  },
  {
    name: "rules",
    path: "/rules",
    component: () => import("./_nuxt/index-B4VmaAYn.js")
  },
  {
    name: "verifyemail",
    path: "/verifyemail",
    component: () => import("./_nuxt/verifyemail-CdmxzMIu.js")
  },
  {
    name: "forgotPassword",
    path: "/forgotPassword",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/forgotPassword-CrR7OM9v.js")
  },
  {
    name: "organizations-new",
    path: "/organizations/new",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/new-DLWqRaix.js")
  },
  {
    name: "organizations-id",
    path: "/organizations/:id()",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/_id_-rzR6as6C.js")
  },
  {
    name: "organizations-join",
    path: "/organizations/join",
    component: () => import("./_nuxt/join-9iUkfkQc.js")
  },
  {
    name: "profile-username",
    path: "/profile/:username()",
    component: () => import("./_nuxt/_username_-CDj5tN4C.js")
  },
  {
    name: "organizations",
    path: "/organizations",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-DfnWrU-D.js")
  },
  {
    name: "auth-callback-provider",
    path: "/auth/callback/:provider()",
    component: () => import("./_nuxt/_provider_-C8y4XCpi.js")
  },
  {
    name: "rules-@owner-name-edit",
    path: "/rules/@:owner()/:name()/edit",
    component: () => import("./_nuxt/edit-KVHlj-D7.js")
  },
  {
    name: "rules-@owner-name",
    path: "/rules/@:owner()/:name()",
    component: () => import("./_nuxt/index-BhpPATai.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-DnvIquN5.js")
};
...
const revive_payload_server_eW_T3fJ6FDvoy87S_lCE0h2sMa9B7u_V0w08IOTgKZw = /* @__PURE__ */ defineNuxtPlugin({
...
const common = { "loading": "読み込み中...", "save": "保存", "cancel": "キャンセル", "delete": "削除", "edit": "編集", "create": "作成", "update": "更新", "search": "検索", "back": "戻る", "next": "次へ", "previous": "前へ", "confirm": "確認", "yes": "はい", "no": "いいえ", "or": "または", "and": "と", "all": "すべて", "none": "なし", "select": "選択", "close": "閉じる", "open": "開く", "download": "ダウンロード", "upload": "アップロード", "share": "共有", "copy": "コピー", "copied": "コピーしました", "error": "エラー", "success": "成功", "warning": "警告", "info": "情報", "required": "必須", "optional": "任意", "providers": { "google": "Google", "github": "GitHub" } };
const nav = { "home": "ホーム", "rules": "ルール", "myRules": "マイルール", "myOrganizations": "マイ組織", "quickAccess": "クイックアクセス", "organizations": "組織", "profile": "プロフィール", "settings": "設定", "logout": "ログアウト", "login": "ログイン", "register": "新規登録", "guides": "ガイド" };
const auth = { "login": { "title": "アカウントにログイン", "subtitle": "まだアカウントをお持ちでない方は", "email": "メールアドレス", "password": "パスワード", "rememberMe": "ログイン状態を保持", "forgotPassword": "パスワードを忘れた方", "loginButton": "ログイン", "loggingIn": "ログイン中...", "loginWith": "{provider}でログイン", "errors": { "invalidCredentials": "メールアドレスまたはパスワードが正しくありません", "emailNotVerified": "メールアドレスを確認してからログインしてください。", "generalError": "ログインに失敗しました" }, "validation": { "emailRequired": "メールアドレスを入力してください", "emailInvalid": "有効なメールアドレスを入力してください", "passwordRequired": "パスワードを入力してください" } }, "register": { "title": "アカウントを作成", "subtitle": "すでにアカウントをお持ちの方は", "username": "ユーザー名", "usernameHint": "英数字、アンダースコア、ハイフンのみ", "email": "メールアドレス", "password": "パスワード", "passwordHint": "8文字以上", "confirmPassword": "パスワード（確認）", "passwordStrength": { "weak": "弱い", "fair": "普通", "good": "強い", "strong": "とても強い" }, "agreeToTerms": "利用規約", "and": "と", "privacyPolicy": "プライバシーポリシー", "agreeToTermsText": "に同意します", "registerButton": "アカウントを作成", "registering": "アカウント作成中...", "registerWith": "{provider}で登録", "accountCreated": "アカウントが作成されました！メールを確認してアカウントを有効化してください。", "accountCreatedShort": "アカウントを作成しました", "errors": { "emailExists": "このメールアドレスは既に使用されています", "usernameExists": "このユーザー名は既に使用されています", "generalError": "アカウントの作成に失敗しました" }, "validation": { "usernameRequired": "ユーザー名を入力してください", "usernameLength": "ユーザー名は3文字以上20文字以下で入力してください", "usernamePattern": "ユーザー名は英数字とアンダースコアのみ使用できます", "emailRequired": "メールアドレスを入力してください", "emailInvalid": "有効なメールアドレスを入力してください", "passwordRequired": "パスワードを入力してください", "passwordLength": "パスワードは8文字以上で入力してください", "passwordMismatch": "パスワードが一致しません", "termsRequired": "利用規約に同意してください" }, "pageTitle": "アカウント作成 - ZXCV" }, "forgotPassword": { "title": "パスワードをリセット", "subtitle": "登録したメールアドレスを入力してください", "email": "メールアドレス", "sendButton": "パスワードリセットメールを送信", "sending": "送信中...", "backToLogin": "ログインに戻る", "success": "パスワードリセットメールを送信しました", "emailSent": "メールを送信しました", "emailSentMessage": "入力されたメールアドレスがアカウントに登録されている場合、パスワードリセットの手順を記載したメールをお送りしました。", "error": "メールの送信に失敗しました。もう一度お試しください。", "pageTitle": "パスワードリセット - zxcv" }, "verifyEmail": { "title": "メールアドレスの確認", "verifying": "アカウントを有効化しています...", "success": "確認完了", "successMessage": "メールアドレスの確認が完了しました。", "successDescription": "ログインページからアカウントにアクセスできます。", "error": "確認エラー", "errorMessage": "メールアドレスの確認に失敗しました。", "invalidToken": "無効または期限切れの確認トークンです。", "invalidTokenDescription": "確認トークンが無効または期限切れです。新しい確認メールを送信してください。", "goToLogin": "ログインページへ", "resendEmail": "確認メールを再送信", "resending": "送信中...", "noToken": "確認トークンがありません", "noTokenMessage": "メールアドレスの確認にはトークンが必要です。", "noTokenDescription": "登録時に送信されたメールのリンクをクリックしてください。", "enterEmail": "メールアドレスを入力してください:", "emailResent": "確認メールを送信しました。メールをご確認ください。", "resendError": "確認メールの送信に失敗しました。", "generalError": "エラーが発生しました。", "pageTitle": "メールアドレスの確認 - zxcv", "register": "新規登録" } };
const home = { "hero": { "badge": "AIコーディングルール管理の新しいスタンダード", "title": "コーディングルールを", "titleHighlight": "共有・管理・活用", "description": "組織全体でコーディング規約を統一。AIに最適化されたルール管理で、開発効率を最大化します。", "viewRules": "ルールを見る", "getStarted": "無料で始める" }, "features": { "title": "FEATURES", "subtitle": "組織開発に必要なすべての機能", "description": "コード品質を保ちながら、開発スピードを向上させる機能を提供", "versionControl": { "title": "バージョン管理", "description": "ルールの変更履歴を自動的に記録。いつでも過去のバージョンに戻すことができます。" }, "organizationCollaboration": { "title": "組織連携", "description": "組織メンバーと簡単に共有。権限管理で安全にルールを管理できます。" }, "aiOptimized": { "title": "AI最適化", "description": "AI開発ツールに最適化された形式でルールを出力。開発効率を向上させます。" } }, "cta": { "title": "今すぐ始めよう", "description": "無料アカウントを作成して、組織のコーディングルールを管理しましょう", "button": "無料で始める" } };
const rules = { "title": "ルール", "myRules": "マイルール", "publicRules": "公開ルール", "organizationRules": "組織ルール", "createRule": "新規ルール作成", "searchPlaceholder": "ルールを検索...", "visibility": { "public": "公開", "private": "非公開", "organization": "組織限定" }, "actions": { "view": "表示", "edit": "編集", "delete": "削除", "share": "共有", "duplicate": "複製", "download": "ダウンロード", "version": "バージョン" }, "form": { "name": "ルール名", "description": "説明", "content": "内容", "tags": "タグ", "visibility": "公開設定", "team": "組織" }, "messages": { "created": "ルールを作成しました", "updated": "ルールを更新しました", "deleted": "ルールを削除しました", "deleteConfirm": "このルールを削除してもよろしいですか？", "deleteError": "ルールの削除に失敗しました" } };
const profile = { "title": "プロフィール", "editProfile": "プロフィールを編集", "username": "ユーザー名", "email": "メールアドレス", "bio": "自己紹介", "website": "ウェブサイト", "joined": "登録日", "backToHome": "ホームに戻る", "emailVerified": "メール認証済み", "emailNotVerified": "メール未認証", "createdRules": "作成したルール", "belongingOrganizations": "所属組織", "registrationDate": "登録日", "recentActivity": "最近のアクティビティ", "noActivityYet": "まだアクティビティがありません", "changeAvatar": "アバターを変更", "avatarChangeComingSoon": "アバター画像の変更は近日実装予定", "usernameHint": "英数字、ハイフン、アンダースコアのみ使用可能", "emailChangeWarning": "メールアドレスを変更すると再認証が必要になります", "changePassword": "パスワードを変更", "currentPassword": "現在のパスワード", "newPassword": "新しいパスワード", "newPasswordConfirm": "新しいパスワード（確認）", "passwordHint": "8文字以上で設定してください", "update": "更新", "change": "変更", "placeholders": { "username": "username", "email": "email@example.com", "currentPassword": "現在のパスワードを入力", "newPassword": "新しいパスワードを入力", "newPasswordConfirm": "新しいパスワードを再入力" }, "errors": { "noUsername": "ユーザー名が指定されていません", "loadFailed": "プロフィールの読み込みに失敗しました", "usernameRequired": "ユーザー名は必須です", "usernameInvalid": "英数字、ハイフン、アンダースコアのみ使用可能です", "usernameMinLength": "3文字以上で入力してください", "emailRequired": "メールアドレスは必須です", "emailInvalid": "有効なメールアドレスを入力してください", "passwordMinLength": "パスワードは8文字以上で設定してください", "passwordMismatch": "パスワードが一致しません", "usernameOrEmailTaken": "そのユーザー名またはメールアドレスは既に使用されています", "updateFailed": "プロフィールの更新に失敗しました", "wrongCurrentPassword": "現在のパスワードが正しくありません", "passwordChangeFailed": "パスワードの変更に失敗しました" }, "success": { "profileUpdated": "プロフィールを更新しました", "passwordChanged": "パスワードを変更しました" }, "stats": { "rules": "ルール", "organizations": "組織", "contributions": "貢献" } };
const settings = { "title": "設定", "account": "アカウント", "security": "セキュリティ", "notifications": "通知", "preferences": "環境設定", "language": "言語", "theme": "テーマ", "changePassword": "パスワードを変更", "twoFactor": "二要素認証", "apiKeys": "APIキー", "deleteAccount": "アカウントを削除" };
const errors = { "notFound": "ページが見つかりません", "unauthorized": "認証が必要です", "forbidden": "アクセス権限がありません", "serverError": "サーバーエラーが発生しました", "networkError": "ネットワークエラーが発生しました", "unknownError": "エラーが発生しました", "oauth": { "authFailed": "OAuth認証に失敗しました", "missingParams": "必要なパラメータが不足しています", "invalidCode": "無効な認証コードです", "invalidState": "無効なstateパラメータです", "accessDenied": "ユーザーがアクセスを拒否しました", "invalidRequest": "無効なリクエストです", "unauthorizedClient": "認証されていないクライアントです", "unsupportedResponseType": "サポートされていないレスポンスタイプです", "invalidScope": "無効なスコープです", "serverError": "認証サーバーでエラーが発生しました", "temporarilyUnavailable": "一時的に利用できません", "registrationFailed": "{provider}でのアカウント作成に失敗しました" } };
const footer = { "copyright": "© 2025 zxcv. All rights reserved.", "about": "zxcvについて", "terms": "利用規約", "privacy": "プライバシーポリシー", "contact": "お問い合わせ", "tagline": "AIコーディングルールを共有・管理・活用するプラットフォーム", "product": "プロダクト", "features": "機能", "pricing": "料金", "enterprise": "エンタープライズ", "changelog": "更新履歴", "resources": "リソース", "docs": "ドキュメント", "api": "API", "blog": "ブログ", "company": "会社情報", "aboutUs": "会社概要", "careers": "採用情報", "partners": "パートナー", "security": "セキュリティ" };
const organizations = { "title": "組織", "subtitle": "組織を作成してメンバーとルールを共有しましょう", "myOrganizations": "マイ組織", "createOrganization": "新しい組織", "joinOrganization": "組織に参加", "members": "メンバー", "rules": "ルール", "owner": "オーナー", "admin": "管理者", "member": "メンバー", "noOrganizations": "まだ組織がありません", "createFirstOrganization": "最初の組織を作成して、メンバーとコラボレーションを始めましょう", "noDescription": "組織の説明はありません", "actions": { "invite": "招待", "leave": "退出", "remove": "削除", "edit": "編集", "manageMembers": "メンバー管理" }, "form": { "name": "組織名", "namePlaceholder": "例: example-company", "description": "説明", "descriptionPlaceholder": "組織の目的や活動内容を記載してください", "inviteEmail": "招待するメールアドレス", "inviteMembers": "初期メンバーを招待（オプション）", "addMember": "メンバーを追加" }, "validation": { "nameRequired": "組織名は必須です", "nameFormat": "組織名は英数字とハイフンのみ使用できます", "invalidEmail": "有効なメールアドレスを入力してください" }, "messages": { "created": "組織を作成しました", "joined": "組織に参加しました", "left": "組織から退出しました", "invited": "招待を送信しました", "inviteAccepted": "招待を承認しました", "createError": "組織の作成に失敗しました", "fetchError": "組織一覧の取得に失敗しました" }, "pageTitle": "組織 - zxcv", "newOrganizationTitle": "新しい組織作成 - zxcv", "createNewOrganization": "新しい組織を作成", "inviteAndCollaborate": "組織を作成してメンバーを招待しましょう", "join": { "verifying": "招待を確認しています...", "failed": "招待の確認に失敗しました", "backToOrganizations": "組織一覧へ", "joined": "組織に参加しました！", "welcome": "組織へようこそ", "goToOrganization": "組織ページへ", "loginRequired": "ログインが必要です", "loginToJoinOrganization": "組織に参加するにはログインが必要です", "login": "ログイン", "noToken": "招待トークンが見つかりません", "invalidToken": "無効な招待トークンです" }, "detail": { "settings": "設定", "leaveOrganization": "組織を離れる", "members": "メンバー", "rules": "ルール", "createdAt": "作成日", "noRules": "まだルールがありません", "inviteMembers": "メンバーを招待", "notFound": "組織が見つかりませんでした", "backToList": "組織一覧に戻る", "removeMember": "メンバーを削除", "confirmRemoveMember": "{{username}}さんを組織から削除してよろしいですか？", "memberRemoved": "{{username}}さんを組織から削除しました", "removeMemberError": "メンバーの削除に失敗しました" }, "inviteMember": { "title": "メンバーを招待", "usernameLabel": "ユーザー名", "usernamePlaceholder": "ユーザー名を入力...", "invite": "招待を送信", "success": "{{username}}さんに招待を送信しました", "error": "招待の送信に失敗しました", "alreadyMember": "このユーザーは既にメンバーです", "alreadyInvited": "このユーザーには既に招待を送信済みです" } };
const test = { "orpc": { "title": "oRPC テストページ", "healthCheck": "ヘルスチェックテスト", "ruleCreate": "ルール作成テスト（認証必須）" } };
const accessibility = { "changeLanguage": "言語を変更", "socialLinks": { "twitter": "Twitter", "github": "GitHub", "discord": "Discord" } };
const placeholders = { "username": "johndoe", "email": "john@example.com" };
const email = { "subjects": { "passwordReset": "【zxcv】パスワードリセットのお知らせ", "emailVerification": "【zxcv】メールアドレスの確認", "organizationInvite": "【zxcv】{organizationName}への招待" } };
  ...
  function t2(key, params) {
    ...
    for (const k2 of keys) {
      if (translation && typeof translation === "object" && k2 in translation) {
        ...
        if (locale.value !== "en") {
          ...
          for (const k22 of keys) {
            if (fallbackTranslation && typeof fallbackTranslation === "object" && k22 in fallbackTranslation) {
              fallbackTranslation = fallbackTranslation[k22];
            } else {
              return `[${key}]`;
            }
          }
    ...
    if (params) {
      return translation.replace(/\{(\w+)\}/g, (match, param) => {
        var _a2;
        return ((_a2 = params[param]) == null ? void 0 : _a2.toString()) || match;
      });
    }
    return translation;
  }
...
function useI18n() {
  ...
  const formatDate = (date, format2 = "short") => {
    const locale = store.locale === "ja" ? "ja-JP" : "en-US";
    const d = typeof date === "string" || typeof date === "number" ? new Date(date) : date;
    const options = format2 === "short" ? { year: "numeric", month: "2-digit", day: "2-digit" } : { year: "numeric", month: "long", day: "numeric", weekday: "long" };
...
const i18n_server_oS2U98YVhbnHilqrm2TjEjU17463eUwNuzUd1wf67ec = /* @__PURE__ */ defineNuxtPlugin(() => {
  const { t: t2 } = useI18n();
  return {
    provide: {
      t: t2
...
const orpc_JYqITcCGUzaUxI6Jyws9AXfMVvmFCGaPSdVXvK2ya6I = /* @__PURE__ */ defineNuxtPlugin((_nuxtApp) => {
  const requestURL = useRequestURL();
  const baseURL2 = `${requestURL.protocol}//${requestURL.host}`;
  ...
  const rpcClient = createORPCClient(link);
  return {
    provide: {
      rpc: rpcClient
    }
...
const plugins = [
  payloadPlugin,
  unhead__l5cQJCU8jr_3zb17LTUbdWrbaP2QA6QnEx_mf3JnCM,
  plugin$1,
  revive_payload_server_eW_T3fJ6FDvoy87S_lCE0h2sMa9B7u_V0w08IOTgKZw,
  plugin,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  i18n_server_oS2U98YVhbnHilqrm2TjEjU17463eUwNuzUd1wf67ec,
  orpc_JYqITcCGUzaUxI6Jyws9AXfMVvmFCGaPSdVXvK2ya6I
];
const layouts = {
  auth: defineAsyncComponent(() => import("./_nuxt/auth-_qZP68sv.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-C1sN2VCE.js").then((m) => m.default || m))
};
...
const useAnimation = () => {
  ...
  const animate = async (element, animationClass, options = {}) => {
    if (!element) {
      return;
    }
    const {
  ...
  const animateStagger = async (elements, animationClass, options = {}) => {
    const { staggerDelay = 50, ...animationOptions } = options;
    const promises2 = Array.from(elements).map(
      (element, index) => animate(element, animationClass, {
        ...animationOptions,
  ...
  const animateOnScroll = (element, animationClass, options = {}) => {
    if (!element) {
      return;
    }
      ...
      (entries) => {
        entries.forEach((entry2) => {
          if (entry2.isIntersecting) {
            animate(entry2.target, animationClass, animationOptions);
            if (once) {
  ...
  const createTimeline = () => {
    const timeline = [];
    const add = (element, animation, options = {}) => {
  ...
  const spring = (element, property, to, options = {}) => {
    if (!element) {
      return;
    }
  ...
  const parallax = (element, speed = 0.5, offset = 0) => {
    if (!element) {
      return;
    }
    const handleScroll = () => {
      const scrolled = (void 0).scrollY;
  ...
  const mouseParallax = (element, sensitivity = 0.1) => {
    if (!element) {
      return;
    }
  ...
  const morph = (element, fromPath, toPath, duration = durations.normal) => {
  ...
  const countUp = (element, start, end, duration = durations.slower, decimals = 0) => {
    if (!element) {
      return;
    }
...
const usePageTransition = () => {
  ...
  const setTransition = (name, mode = "out-in") => {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: { "theme-transition": unref(themeTransition) }
      }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BlZC8B15.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-C1W8c5mq.js"));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.7_@biomejs+biome@2.1.2_@netlify+blobs@9.1.2_@parcel+watcher@2.5.1_@types+node_639a525bd398eaabb93b667a9f677058/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.7_@biomejs+biome@2.1.2_@netlify+blobs@9.1.2_@parcel+watcher@2.5.1_@types+node_639a525bd398eaabb93b667a9f677058/node_modules/nuxt/dist/app/components/nuxt-root.vue");
