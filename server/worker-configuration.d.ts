/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e8289a2bf2f963639c90400dc50713a2)
...
declare namespace Cloudflare {
	interface Env {
		...
		FRONTEND_URL: "https://zxcv-backend-and-frontend.mattya.workers.dev/";
		R2: R2Bucket;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_ALGORITHM" | "JWT_EXPIRES_IN" | "RATE_LIMIT_ANONYMOUS" | "RATE_LIMIT_AUTHENTICATED" | "RATE_LIMIT_API_KEY" | "EMAIL_FROM" | "FRONTEND_URL">> {}
}
